...
function getVentasRegistradas(){
	tabla = $('#tbllistado').dataTable(
	{
		...
		"ajax": {
					url: '../ajax/GenericAjax.php?op=getVentas',
					type: 'get',
					dataType: 'json',
					error: function(e){
...
function redirigirRegistrarVenta() {
	eliminarArticulosVenta();
	//sessionStorage.setItem("registroVenta",true);
...
function eliminarArticulosVenta(){
	$.post("../ajax/GenericAjax.php?op=deteleArticulosVenta", function(r){
    });
}
